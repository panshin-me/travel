...
The pocket-size <!--more-->booklet contains an actual admission ticket to each attraction. And with a CityPass you’ll avoid ticket lines at most attractions. New York CityPass is valid for nine leisurely days from day of first use. One admission to each of the following attractions is included:
